...
export function loadModels(): void {
  ...
  const models: [string, number][] = [
    ['nettools/dns-lookup',      0.0075],
    ['nettools/dns-propagation', 0.015],
    ['nettools/reverse-dns',     0.0075],
    ['nettools/ssl-check',       0.01],
    ['nettools/whois',           0.01],
    ['nettools/port-check',      0.0075],
    ['nettools/ping',            0.0075],
    ['nettools/mx-check',        0.01],
    ['nettools/ip-info',         0.005],
    ['nettools/ip-geo',          0.01],
    ['nettools/my-ip',           0.005],
    ['nettools/cert-decode',     0.0075],
  ];
...
export function loadConfig(): ProviderConfig {
  ...
  return {
    ...
    providerName: optionalEnv('PROVIDER_NAME', 'HS58-Nettools'),
