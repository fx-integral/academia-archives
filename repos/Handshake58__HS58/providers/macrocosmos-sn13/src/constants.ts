...
// Macrocosmos SN13 Data Universe
export const SN13_BASE_URL = 'https://sn13.api.macrocosmos.ai';
export const SN13_DATA_REQUEST_PATH = '/api/v1/on_demand_data_request';
export const SN13_SET_DESIRABILITIES_PATH = '/api/v1/set_desirabilities';
export const SN13_LIST_REPOS_PATH = '/api/v1/list_repo_names';
export const SN13_RATE_LIMIT_PER_HOUR = 100;
