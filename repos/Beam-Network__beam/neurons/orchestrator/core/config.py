...
class OrchestratorSettings(BaseSettings):
    ...
    # ==========================================================================
    subnet_core_url: str = Field(default="http://localhost:8080", env="SUBNET_CORE_URL")
    ...
    # ==========================================================================
    registry_url: Optional[str] = Field(default=None, env="REGISTRY_URL")
    ...
    def model_post_init(self, __context) -> None:
        ...
        if not self.registry_url:
            self.registry_url = self.subnet_core_url
