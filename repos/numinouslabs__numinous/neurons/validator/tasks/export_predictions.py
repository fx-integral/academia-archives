...
class ExportPredictions(AbstractTask):
    ...
    def parse_predictions_for_exporting(self, predictions_db_data: list[tuple[any]]):
        ...
        for prediction_data in predictions_db_data:
            ...
            track = prediction_data[4]
            event_type = prediction_data[5]
            predicted_outcome = prediction_data[6]
            interval_start_minutes = prediction_data[7]
            interval_agg_prediction = prediction_data[8]
            interval_count = prediction_data[9]
            submitted_at = prediction_data[10]
            run_id = prediction_data[11]
            version_id = prediction_data[12]
