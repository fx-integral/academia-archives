...
/// @title ExecuteUpgradeOVDeriveEarlyExit
/// @notice Executes the v1616 OV upgrade batch after the timelock delay.
///         Pairs with ScheduleUpgradeOVDeriveEarlyExit.
contract ExecuteUpgradeOVDeriveEarlyExit is Script {
    ...
    function run() external {
        ...
        address ovImpl = vm.envAddress("OV_IMPL_DERIVE_EE");
        TimelockController timelock = TimelockController(payable(TIMELOCK));

        console.log("Executor:", vm.addr(executorKey));
        console.log("OV impl (v1616):", ovImpl);
        ...
        console.log("OV v1616 derive-early-exit upgrade executed. Batch ID:");
