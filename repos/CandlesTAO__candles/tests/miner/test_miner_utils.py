...
1750708527,green,0.54,300.52"""
            ...
            try:
                ...
                with patch(
                    "candles.miner.utils.get_next_timestamp_by_interval",
                    return_value=next_timestamp,
                ):
            ...
            try:
                ...
                with patch(
                    ...
                    result = get_file_predictions(
                        filename=temp_file.name, interval=TimeInterval.HOURLY
                    )
            ...
            try:
                ...
                with patch(
                    ...
                    with patch("candles.miner.utils.build_prediction") as mock_build:
                        ...
                        assert (
                            call_args["timestamp"] == 1750704927
                        )  # Equal timestamp should be used
