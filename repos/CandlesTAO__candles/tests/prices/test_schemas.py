...
class TestCoinDeskResponseOHLC:
    ...
    @pytest.mark.parametrize(
        "open_price,close_price,expected_color",
        [
    ...
    def test_parse_response_color_logic(
        self, open_price: float, close_price: float, expected_color: CandleColor
    ):
    ...
    def test_parse_response_string_numbers(self):
        ...
        data = {"OPEN": "50000", "CLOSE": "49000", "TIMESTAMP": "2023-01-01T00:00:00Z"}
    ...
    def test_parse_response_zero_prices(self):
        ...
        data = {"OPEN": "0.0", "CLOSE": "0.0", "TIMESTAMP": "2023-01-01T00:00:00Z"}
