...
---
# AB Sniffer v4 (Active after Oct 16th 2025 10:00 UTC)

## Overview

**AB Sniffer v4** is the next iteration of the **Auto Browser Sniffer** challenge. With this iteration, we are introducing more frameworks to be detected: **Botasaurus**, **Pydoll**, and a **human-in-the-loop** interaction scenario.
