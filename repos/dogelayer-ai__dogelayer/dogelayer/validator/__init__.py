...
from dogelayer.core.constants import BLOCK_TIME
from dogelayer.core.pool import Pool
from dogelayer.core.pricing import CoinPriceAPI
from dogelayer.validator.storage import (
    ...
    def setup_bittensor_objects(self) -> None:
        ...
        try:
            ...
            if "get_selective_mechagraph" in str(e):
                logging.warning(f"get_selective_mechagraph not available, trying alternative method: {e}")
                # Try using the old API method
